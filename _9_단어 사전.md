...
## A : Asynchronous, Advanced, Amplitude, Automatic
...
CD - [C5] Cp;;osopm Detection/ 데이터 프레임을 전송하면서 충돌 여부를 조사  
...
IAB - Internet Architecture Board/ 인터넷 아키텍처 위원회/ 표준안 제정 기관 중 하나.  
ICMP - Internet Control Message Protocol/ IP에서 발생하는 문제를 처리하기 위한 프로토콜
IEC - International Electrotechnical Commission/ 국제전기표준협회/ 표준안 제정 기관 중 하나.  
IETF - Internet Engineering Task Force/ 인터넷 엔지니어링 테스크 포스/ 표준안 제정 기관 중 하나.  
IGMP - Internet Group Message Protocol/ 인터넷 그룹 관리 프로토콜  
IP - Internet Protocol  
IRTF - Internet Research Task Force/ 인터넷 태스크 포스/ 표준안 제정 기관 중 하나.
ITU - International Telecommunication Union/ 전기 통신 전반에 걸친 최고 국제 기구./ 표준안 제정 기관 중 하나. 
```
ITU-T - ITU-Telecommunication Standardization Sector/ 전기통신표준화 부문
ITU-R - ITU-Radiocommunication Sector/ 무선 통신 부문
ITU-D - ITU-Telecommunication Development Sector/ 전기통신개발 부문
```
ISO - International Organization for Standardization/ 표준안 제정 기관 중 하나.  
...
## P : Protocol, Pharse, Public, Photo
PAD - [C5]  
...
## S : Signal, Synchronous
SAP - 서비스 접근점  
SDU - Service Date Unit/ 서비스 데이터 단위  
